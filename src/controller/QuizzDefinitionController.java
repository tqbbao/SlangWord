...
import view.QuizzDefinitionView;
 ...
 * @author MSI VN
 */
public class QuizzDefinitionController implements ActionListener {

    public SlangWordView rootPanel;
    public QuizzDefinitionView panel;

    public QuizzDefinitionController(QuizzDefinitionView panel) {
        this.panel = panel;
    }
...
//
        for (int i = 0; i < 4; i++) {
            ...
            if (answer == i) {
                ...
                this.panel.questionLabel.setText(randomValue);
            }
            if (i == 0) {

                this.panel.ansA.setText(randomKey);

            } else if (i == 1) {

                this.panel.ansB.setText(randomKey);

            } else if (i == 2) {

                this.panel.ansC.setText(randomKey);
            } else if (i == 3) {

                this.panel.ansD.setText(randomKey);
